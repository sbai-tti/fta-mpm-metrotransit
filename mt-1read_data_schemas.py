...
schema_output_path = os.path.join(base_dir, "schemas.txt")
...
passups_path = os.path.join(base_dir, "passups/*/*/*.parquet")
try:
...
# 6. stop_crossings
stop_crossings_path = os.path.join(base_dir, "stop_crossings/*/*/*.parquet")
try:
...
# 7. vehicle_locations
vehicle_locations_path = os.path.join(base_dir, "vehicle_locations/*/*.parquet")
try:
...
# 8. stop_visits 
stop_visits_path = os.path.join(base_dir, "stop_visits/*/*/*.parquet")
try:
...
# 9. fare_transactions 
fare_transactions_path = os.path.join(base_dir, "fare_transactions/*/*/*.parquet")
try:
